...
public void register(User user)throws BadRequestException {
    ...
    if (userRepository.existsByEmail(user.getEmail())){
        ...
        throw new ConflictException("email kullanılıyor unıq değil ");
    ...
    public void login(String email, String password) throws AuthException {  // basit bir proje olrsa kullan
        try {
